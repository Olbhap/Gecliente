...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { comentario: @factura.comentario, fecha_alta: @factura.fecha_alta, numero_factura: @factura.numero_factura, serie_factura: @factura.serie_factura }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { comentario: @factura.comentario, fecha_alta: @factura.fecha_alta, numero_factura: @factura.numero_factura, serie_factura: @factura.serie_factura }
    assert_redirected_to factura_path(assigns(:factura))
  end
